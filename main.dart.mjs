...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      GJ: x0 => x0.image,
      GK: x0 => x0.name,
      GL: (x0,x1) => x0.getModifierState(x1),
      GM: (x0,x1) => { x0.cMapUrl = x1 },
      ...
      KJ: (x0,x1) => x0.get(x1),
      KK: x0 => x0.files,
      KL: x0 => x0.isComposing,
      KM: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      L: o => {
      ...
      LL: x0 => x0.code,
      LM: () => globalThis.Notification.requestPermission(),
      M: x0 => x0.index,
      ...
      UL: (x0,x1,x2) => x0.setAttribute(x1,x2),
      UM: x0 => x0.geolocation,
      V: o => o,
      ...
      YL: (x0,x1) => { x0.target = x1 },
      YM: (x0,x1) => x0.querySelector(x1),
      Z: x0 => x0.ignoreCase,
      ZB: (o, p) => o[p],
      ...
      bL: x0 => x0.document,
      bM: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      c: (c) =>
      ...
      cL: (x0,x1) => { x0.exports = x1 },
      cM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      ...
      gK: x0 => globalThis.URL.revokeObjectURL(x0),
      gL: (x0,x1) => { x0.async = x1 },
      ...
      jJ: (a, l) => a.length = l,
      jK: () => new XMLHttpRequest(),
      jL: () => ({}),
      jM: (x0,x1) => { x0.onerror = x1 },
      k: (constructor, args) => {
      ...
      kK: (x0,x1,x2) => x0.open(x1,x2),
      kL: x0 => globalThis.pdfjsLib.getDocument(x0),
      kM: (x0,x1) => { x0.oncancel = x1 },
      l: x0 => new Array(x0),
      ...
      mK: x0 => x0.send(),
      mL: (x0,x1) => x0.getPage(x1),
      mM: x0 => x0.lastModified,
      n: (o0, o1) => [o0, o1],
      nB: o => {
        if (o === null || o === undefined) return 0;
      ...
      oK: x0 => x0.upload,
      oL: (x0,x1) => x0.render(x1),
      oM: (x0,x1) => x0.replaceChildren(x1),
      ...
      rJ: x0 => x0.children,
      rK: x0 => x0.getAllResponseHeaders(),
      rL: x0 => x0.cleanup(),
      rM: x0 => x0.value,
      s: () => globalThis,
      ...
      vK: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      vL: x0 => x0.promise,
      vM: x0 => x0.loader,
      w: (l, r) => l === r,
      ...
      wK: (x0,x1) => { x0.withCredentials = x1 },
      wL: (x0,x1) => { x0.viewport = x1 },
      wM: () => globalThis._flutter,
      x: x0 => x0.random(),
      xB: o => {
        if (o === null || o === undefined) return 0;
      ...
      xK: (x0,x1) => { x0.responseType = x1 },
      xL: (x0,x1) => { x0.canvasContext = x1 },
      y: () => globalThis.Math,
