...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BL: x0 => x0.statusText,
      BM: (x0,x1) => { x0.viewport = x1 },
      BN: () => globalThis._flutter,
      ...
      CL: x0 => x0.getAllResponseHeaders(),
      CM: (x0,x1) => { x0.canvasContext = x1 },
      ...
      FJ: x0 => x0.duration,
      FK: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      FL: x0 => x0.withCredentials,
      ...
      HK: () => new FileReader(),
      HL: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      HM: (x0,x1) => { x0.scale = x1 },
      ...
      IJ: (x0,x1) => x0.getRandomValues(x1),
      IK: (x0,x1) => x0.readAsArrayBuffer(x1),
      IL: (x0,x1) => { x0.withCredentials = x1 },
      IM: x0 => x0.numPages,
      ...
      JJ: () => globalThis.crypto,
      JK: x0 => ({type: x0}),
      JL: (x0,x1) => { x0.responseType = x1 },
      JM: x0 => x0.promise,
      K: o => o,
      ...
      KJ: l => new DataView(new ArrayBuffer(l)),
      KK: (x0,x1) => new Blob(x0,x1),
      KL: (x0,x1) => x0.getItem(x1),
      KM: (x0,x1) => { x0.cMapPacked = x1 },
      L: o => {
      ...
      LJ: (x0,x1,x2) => x0.open(x1,x2),
      LK: x0 => globalThis.URL.createObjectURL(x0),
      LL: x0 => x0.localStorage,
      LM: (x0,x1) => { x0.cMapUrl = x1 },
      M: x0 => x0.index,
      ...
      PK: x0 => x0.result,
      PL: (x0,x1) => x0.appendChild(x1),
      PM: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      ...
      QK: x0 => x0.length,
      QL: x0 => x0.remove(),
      QM: () => globalThis.Notification.requestPermission(),
      R: o => o,
      ...
      SJ: x0 => x0.matches,
      SK: (x0,x1) => { x0.display = x1 },
      SL: (x0,x1) => x0.removeItem(x1),
      SM: (x0,x1) => x0.getUserMedia(x1),
      ...
      TJ: (x0,x1) => x0.get(x1),
      TK: x0 => x0.style,
      TL: x0 => x0.hostElement,
      TM: x0 => x0.getVideoTracks(),
      ...
      VJ: x0 => x0.headers,
      VK: (x0,x1) => { x0.multiple = x1 },
      VL: (x0,x1) => x0.getModifierState(x1),
      VM: x0 => x0.active,
      W: o => {
        if (o === undefined || o === null) return 0;
      ...
      ZK: x0 => new Blob(x0),
      ZL: x0 => x0.isComposing,
      ZM: x0 => x0.geolocation,
      a: x0 => x0.multiline,
      ...
      aK: x0 => globalThis.URL.revokeObjectURL(x0),
      aL: x0 => x0.code,
      ...
      eI: (o, p) => p in o,
      eJ: x0 => x0.name,
      eK: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      eL: x0 => x0.reload(),
      eM: (x0,x1) => { x0.id = x1 },
      ...
      gL: (x0,x1) => { x0.hash = x1 },
      gM: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      hL: x0 => x0.location,
      hM: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      i: x0 => new Promise(x0),
      iB: o => {
        if (o === null || o === undefined) return 0;
      ...
      iJ: x0 => x0.getReader(),
      iK: x0 => x0.convertToBlob(),
      iL: (x0,x1) => x0.getElementById(x1),
      iM: x0 => x0.height,
      ...
      jJ: x0 => x0.read(),
      jK: (x0,x1,x2) => new ImageData(x0,x1,x2),
      ...
      mJ: x0 => x0.cancel(),
      mK: x0 => x0.allocationSize(),
      mL: (x0,x1) => { x0.innerHTML = x1 },
      ...
      oJ: x0 => x0.headers,
      oK: (x0,x1) => x0.toDataURL(x1),
      oL: () => ({}),
      oM: (x0,x1) => { x0.onerror = x1 },
      ...
      pI: x0 => x0.URL,
      pJ: x0 => x0.signal,
      pK: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      pL: x0 => globalThis.pdfjsLib.getDocument(x0),
      pM: (x0,x1) => { x0.oncancel = x1 },
      q: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      rL: (x0,x1) => x0.getPage(x1),
      rM: x0 => x0.lastModified,
      s: () => globalThis,
      ...
      sK: (x0,x1,x2) => x0.open(x1,x2),
      sL: (x0,x1) => x0.getViewport(x1),
      sM: x0 => x0.target,
      ...
      tK: (x0,x1) => x0.send(x1),
      tL: (x0,x1) => x0.render(x1),
      tM: (x0,x1) => x0.replaceChildren(x1),
      ...
      vH: x0 => x0.content,
      vI: x0 => x0.frameCount,
      vJ: (x0,x1) => x0.removeChild(x1),
      vK: x0 => x0.abort(),
      vL: (x0,x1) => x0.toBlob(x1),
      vM: x0 => x0.getReader(),
      w: (l, r) => l === r,
